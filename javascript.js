...
'salt shaker', 'pepper shaker', 'pepper grinder', 'oil bottle', 'vinegar bottle', 'sugar canister', 'flour canister', 'coffee canister', 'tea canister',
...
'recycling bags', 'light bulbs', 'extension cord', 'power strip', 'smoke detector', 'carbon monoxide detector', 'canned goods', 'dry pasta', 'rice bags',
...
'herb scissors', 'oil sprayer', 'butcher block', 'knife magnet strip', 'dish warmer', 'warming drawer', 'cabinet locks', 'child safety latches', 'drawer slides',
'water filter pitcher', 'replacement filters', 'ice trays', 'freezer bins', 'freezer bags', 'produce bins', 'egg holder', 'butter keeper', 'condiment rack',
...
'jar opener', 'cleaver', 'fillet knife', 'boning knife', 'carving fork', 'kitchen mallet',
'sauce whisk', 'balloon whisk', 'dough scraper', 'pastry brush', 'pastry blender', 'baking molds', 'souffle dish', 'ramekins', 'custard cups',
...
'storage baskets', 'wire baskets', 'plastic bins', 'glass jars', 'spice tins', 'tea kettle', 'whistling kettle', 'coffee mugs set',

'water carafe', 'pitcher with lid', 'salad bowl', 'mixing pitcher', 'batter bowl', 'sifter', 'strainer set', 'colander set', 'food mill', 'ricer',
'egg slicer', 'cheese slicer', 'canisters with lids', 'airtight containers', 'bread basket', 'fruit bowl', 'banana hanger', 'napkin rings', 'table runner',
'chair cushions', 'seat covers', 'high chair', 'booster seat', 'pet food bin', 'pet bowls', 'step trash can', 'touchless trash can', 'cabinet shelf riser',
'plate e set', 'cut resistant gloves', 'oven rack guards', 'sink drying rack', 'dish drainer tray', 'kitchen storage cabinet', 
'under sink mat', 'sink organizer rack', 'pull out cabinet organizer', 'corner cabinet organizer', 'cabinet basket insert', 'stackable pantry bins', 'clear storage bins', 'food storage turntable', 'pantry label set',

'chalkboard labels', 'nested mixing bowls', 'collapsible colander', 'silicone baking mat', 'silicone spatula set', 'wooden utensil set', 'cookware organizer rack', 'under cabinet mug hooks', 'hanging fruit basket',
...
'thermal casserole carrier', 'insulated food carrier', 'serving caddy', 'condiment caddy', 'picnic cooler', 'rolling cooler', 'ice chest', 'food storage jar set', 'glass canister set', 'ceramic canister set',
 'airtight cereal containers', 'flour storage bin', 'sugar storage bin', 'rice dispenser', 'pet food storage container', 'beverage dispenser', 'drink dispenser stand', 'coffee pod holder', 'coffee pod drawer',

'espresso tamper', 'milk frothing pitcher', 'coffee knock box', 'tea infuser', 'tea kettle electric', 'tea kettle stovetop', 'refrigerator deodorizer', 'freezer thermometer',
...
'ice scoop', 'bar spoon', 'cocktail shaker', 'cocktail strainer', 'jigger', 'mudler', 'drink mixing glass', 'gold flatware set', 
 'butter knives', 'seafood forks', 'soup spoons', 'dessert spoons', 'salad forks', 'dinner forks', 'dinner knives', 'teaspoons', 'tablespoons',

'steak knife block', 'china dinner set', 'stoneware dinner set', 'porcelain dinner set', 'melamine plate set', 'glass salad bowl', 'wood salad bowl', 'ceramic serving bowl', 'pasta serving bowl',
...
'carafe', 'coffee carafe', 'tea pot', 'gravy ladle', 'table centerpiece', 'decorative tray',
'countertop tray', 'fruit storage basket', 'banana tree stand', 'dish soap dispenser', 'hand soap dispenser', 'cleaning caddy',
'all purpose cleaner', 'glass cleaner', 'granite cleaner', 'wood cleaner', 'oven cleaner', 'dishwasher cleaner', 'garbage disposal cleaner', 'drain cleaner', 'scrub sponges',
...
'cookware cleaner', 'dish drying cabinet', 'over sink drying rack', 'cabinet door organizer', 'measuring conversion chart', 'grocery bag holder', 'reusable grocery bags', 'insulated grocery bags', 'cooler tote', 'picnic tableware set',
...
'cleaning supply rack', 'trash can deodorizer', 'recycling sorter bins', 'compost filter replacements', 'drawer freshener', 'cabinet freshener', 'air purifier small', 'backup batteries', 'surge protector strip', 'extension cord reel', 'folding step ladder large', 'fire resistant safe', 'document organizer box', 'recipe storage box',
...
'silicone cupcake liners', 'reusable baking cups', 'oven thermometer analog', 'freezer thermometer analog', 'cookie cooling tower', 'knife sharpening guide',

'cutting board stand', 'drawer knife organizer bamboo', 'rolling pin marble', 'rolling pin wood', 'flour shaker', 'powdered sugar shaker', 'oil sprayer bottle', 'vinegar cruet', 'salad dressing shaker',
'grill press', 'panini weight', 'cast iron press', 'bacon press', 'pot clip strainer', 'collapsible funnel', 'kitchen funnel set', 'measuring cup glass',
'measuring cup plastic', 'oven rack pull tool',
...
'salad dressing mixer', 'herb stripping tool', 'meat shredder claws', 'taco holder stand', 'baking sheet rack', 'spice measuring spoons', 'citrus reamer', 'garlic slicer', 'herb chopper',
...
'saucers', 'mugs', 'flatware set', 'dinner forks', 'salad forks', 'dinner knives', 'steak knives', 'soup spoons', 'teaspoons', 'ladle', 'tongs', 'cake server', 'pie server', 'bread basket', 'bread basket liner', 'cake stand', 'tiered tray', 'dessert plates',
...
'champagne flute storage case', 'cocktail glass storage case', 'highball glass storage rack', 'beer mug storage crate', 'coffee cup organizer', 'tea cup display shelf', 'mug tree', 'flatware drawer tray', 'silverware polishing cloth', 'steak knife storage block',
 'ladle holder', 'tongs stainless steel', 'cake knife', 'pie server stainless steel', 'bread knife', 'bread cutting board', 'cake dome cover', 'dessert stand cover',
...
'plastic tub large', 'storage drum waterproof', 'weatherproof document case', 'steel lock box', 'portable filing cabinet', 'rolling filing cart', 'accordion file organizer', 'clip file box', 'archival photo box', 'blueprint storage tube'
    ...
    const ITEM_IMAGE_OVERRIDES = {
        ...
        'serving bowl large': 'https://cdamemoryjogger.blob.core.windows.net/images/serving%20bowl%20large.jpg',
        'serving bowl small': 'https://cdamemoryjogger.blob.core.windows.net/images/serving%20bowl%20small.jpg',
        'mixing bowl stainless': 'https://cdamemoryjogger.blob.core.windows.net/images/mixing%20bowl%20stainless.jpg',
        'mixing bowl glass': 'https://cdamemoryjogger.blob.core.windows.net/images/mixing%20bowl%20glass.jpg',
        'mixing bowl ceramic': 'https://cdamemoryjogger.blob.core.windows.net/images/mixing%20bowl%20ceramic.jpg',
        'frying pan stainless': 'https://cdamemoryjogger.blob.core.windows.net/images/frying%20pan%20stainless.jpg',
        'frying pan nonstick': 'https://cdamemoryjogger.blob.core.windows.net/images/frying%20pan%20nonstick.jpg',
        'saucepan stainless': 'https://cdamemoryjogger.blob.core.windows.net/images/saucepan%20stainless.jpg',
        'saucepan nonstick': 'https://cdamemoryjogger.blob.core.windows.net/images/saucepan%20nonstick.jpg',
        'stock pot stainless': 'https://cdamemoryjogger.blob.core.windows.net/images/stock%20pot%20stainless.jpg',
        'stock pot enamel': 'https://cdamemoryjogger.blob.core.windows.net/images/stock%20pot%20enamel.jpg',
        'tea kettle stainless': 'https://cdamemoryjogger.blob.core.windows.net/images/tea%20kettle%20stainless.jpg',
        'tea kettle glass': 'https://cdamemoryjogger.blob.core.windows.net/images/tea%20kettle%20glass.jpg',
        'coffee storage jar': 'https://cdamemoryjogger.blob.core.windows.net/images/coffee%20storage%20jar.jpg',
        'sugar storage jar': 'https://cdamemoryjogger.blob.core.windows.net/images/sugar%20storage%20jar.jpg',
        'flour storage jar': 'https://cdamemoryjogger.blob.core.windows.net/images/flour%20storage%20jar.jpg',
        'rice storage jar': 'https://cdamemoryjogger.blob.core.windows.net/images/rice%20storage%20jar.jpg',
        'utensil crock ceramic': 'https://cdamemoryjogger.blob.core.windows.net/images/utensil%20crock%20ceramic.jpg',
        'utensil crock stainless': 'https://cdamemoryjogger.blob.core.windows.net/images/utensil%20crock%20stainless.jpg',
        'knife sharpening kit': 'https://cdamemoryjogger.blob.core.windows.net/images/knife%20sharpening%20kit.jpg',
        'food thermometer instant read': 'https://cdamemoryjogger.blob.core.windows.net/images/food%20thermometer%20instant%20read.jpg',
        'kitchen command center board': 'https://cdamemoryjogger.blob.core.windows.net/images/kitchen%20command%20center%20board.jpg',
        'magnetic spice tins': 'https://cdamemoryjogger.blob.core.windows.net/images/magnetic%20spice%20tins.jpg',
        'magnetic knife holder': 'https://cdamemoryjogger.blob.core.windows.net/images/magnetic%20knife%20holder.jpg',
        'drawer utensil tray': 'https://cdamemoryjogger.blob.core.windows.net/images/drawer%20utensil%20tray.jpg',
        'kitchen apron hooks': 'https://cdamemoryjogger.blob.core.windows.net/images/kitchen%20apron%20hooks.jpg',
        'rolling storage bin': 'https://cdamemoryjogger.blob.core.windows.net/images/rolling%20storage%20bin.jpg'
    };
