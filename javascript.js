(function () {
    ...
    const ITEM_OPTIONS = {
        ...
        'Living room': ['Sectional sofa', 'Sofa', 'Loveseat', 'Reclining sofa', 'Recliner chair', 'Armchair', 'Accent chair', 'Club chair', 'Chaise lounge', 'Ottoman', 'Storage ottoman', 'Footstool', 'Coffee table', 'Lift-top coffee table', 'Glass coffee table', 'End table', 'Side table', 'Console table', 'Sofa table', 'TV stand', 'Entertainment center', 'Media console', 'Wall-mounted TV bracket', 'Television', 'Streaming device', 'DVD player', 'Blu-ray player', 'Soundbar', 'Subwoofer', 'Home theater receiver', 'Surround sound speakers', 'Speaker stands', 'Remote control', 'Universal remote', 'Gaming console', 'Video game controllers', 'VR headset', 'Cable box', 'Satellite receiver', 'Internet modem', 'Wi-Fi router', 'Smart home hub', 'Surge protector', 'Power strip', 'Extension cord',
            'Floor lamp', 'Table lamp', 'Desk lamp', 'Reading lamp', 'Lamp shade', 'Light bulbs', 'Smart bulbs', 'Ceiling fan remote', 'Area rug', 'Runner rug', 'Rug pad', 'Carpet cleaner', 'Throw blanket', 'Fleece blanket', 'Quilt', 'Decorative pillows', 'Pillow covers', 'Cushion inserts', 'Curtains', 'Drapes', 'Sheer curtains', 'Curtain rods', 'Curtain rings', 'Blinds', 'Window shades', 'Valance', 'Wall art', 'Framed picture', 'Canvas print', 'Poster frame', 'Picture frames', 'Family photo album', 'Mirror', 'Wall mirror', 'Decorative clock', 'Wall clock', 'Mantel clock', 'Bookshelf', 'Bookcase', 'Floating shelves', 'Display cabinet', 'Curio cabinet', 'Storage cabinet', 'Storage basket', 'Woven basket', 'Magazine rack', 'Magazine stack', 'Books', 'Coffee table books', 'Board games',
            'Card games', 'Puzzle box', 'Chess set', 'Checkers set', 'Backgammon set', 'Dice set', 'Playing cards', 'Game storage box', 'Throw pillow', 'Accent pillow', 'Pet bed', 'Pet toys', 'Cat scratching post', 'Dog leash', 'Dog collar', 'Cat litter mat', 'Decorative vase', 'Flower vase', 'Artificial flowers', 'Houseplant', 'Plant pot', 'Planter', 'Plant stand', 'Terrarium', 'Candle', 'Scented candle', 'Candle holder', 'Lantern', 'Incense holder', 'Reed diffuser', 'Air freshener', 'Decorative tray', 'Coaster set', 'Drink coasters', 'Serving tray', 'Bowl set', 'Decorative bowl', 'Candy dish', 'Key bowl', 'Entryway hooks', 'Coat rack', 'Umbrella stand', 'Umbrella', 'Shoe rack', 'Shoe tray', 'Door mat', 'Blanket ladder', 'Storage trunk', 'Hope chest', 'Accent bench', 'Window seat cushion',
            'Fireplace tools', 'Fireplace screen', 'Firewood rack', 'Firewood', 'Electric fireplace', 'Space heater', 'Portable fan', 'Humidifier', 'Dehumidifier', 'Air purifier', 'Thermostat', 'Smart thermostat', 'Wall thermostat cover', 'Batteries', 'Battery charger', 'Flashlight', 'Candles', 'Lighter', 'Matches', 'First aid kit', 'Fire extinguisher', 'Smoke detector', 'Carbon monoxide detector', 'Tool kit', 'Screwdriver set', 'Hammer', 'Tape measure', 'Scissors', 'Utility knife', 'Super glue', 'Duct tape', 'Masking tape', 'Command hooks', 'Picture hanging kit', 'Nails', 'Screws', 'Furniture pads', 'Furniture sliders', 'Cleaning spray', 'Glass cleaner', 'Furniture polish', 'Microfiber cloths', 'Dusting wand', 'Feather duster', 'Vacuum cleaner', 'Broom', 'Dustpan', 'Mop', 'Bucket',
            'Trash can', 'Trash bags', 'Recycling bin', 'Storage bins', 'Plastic storage tote', 'Decorative storage box', 'Mail organizer', 'Letter opener', 'Stamp book', 'Pens', 'Notepad', 'Clipboard', 'Sticky notes', 'Phone charger', 'Charging cable', 'Charging dock', 'Laptop', 'Tablet', 'E-reader', 'Headphones', 'Bluetooth speaker', 'Smart speaker', 'Digital photo frame', 'Camera', 'Camera charger', 'Tripod', 'Binoculars', 'Sunglasses', 'Reading glasses', 'Game console dock', 'HDMI cables', 'Optical audio cable', 'Ethernet cable', 'Cable ties', 'Cord organizer', 'Cable management box', 'Throw rug', 'Decorative lantern', 'Seasonal decor', 'Holiday decorations', 'String lights', 'Decorative garland', 'Wreath', 'Decorative figurines', 'Sculpture', 'Statue', 'Collectible items', 'Trophy',
            'Plaques', 'Musical instrument', 'Guitar stand', 'Piano bench', 'Record player', 'Vinyl records', 'CDs', 'CD storage case', 'Speakers', 'Amplifier', 'Microphone', 'Microphone stand', 'Sheet music', 'Music books', 'Karaoke machine', 'Karaoke microphones', 'Bar cart', 'Wine rack', 'Wine glasses', 'Decanter', 'Bottle opener', 'Cocktail shaker', 'Ice bucket', 'Serving glasses', 'Snack bowls', 'Popcorn bowl', 'Console cabinet', 'Blanket storage basket', 'Remote holder', 'Armrest organizer', 'Lap desk', 'TV antenna', 'Indoor antenna', 'Projector', 'Projector screen', 'HD projector cable', 'Decorative pouf', 'Floor cushions', 'Meditation cushion', 'Yoga mat', 'Foam roller', 'Exercise bands', 'Small dumbbells', 'Storage cube organizer', 'Cube storage bins', 'Wall shelves', 'Art supplies',
            'Sketchbook', 'Colored pencils', 'Markers', 'Craft storage box', 'Sewing kit', 'Knitting basket', 'Yarn', 'Fabric scraps', 'Glue gun', 'Glue sticks', 'Scrapbook', 'Scrapbook supplies', 'Office chair', 'Folding chair', 'Extra seating stool', 'Accent stool', 'Step stool', 'Wall hooks', 'Entryway bench', 'Console mirror', 'Decorative sign', 'Chalkboard', 'Whiteboard', 'Dry erase markers', 'Board eraser', 'Notices board', 'Corkboard', 'Push pins', 'Clips', 'Small safe', 'Lock box', 'Important documents folder', 'Document organizer', 'Filing box', 'File folders', 'Binder', 'Binders', 'Portfolio case', 'Printer', 'Printer paper', 'Ink cartridges', 'Shredder', 'Desk organizer', 'Coin jar', 'Piggy bank', 'Loose change tray', 'Jewelry box', 'Watch box', 'Gift bags', 'Wrapping paper', 'Tape dispenser',
            'Ribbon', 'Gift tags', 'Greeting cards', 'Envelopes', 'Stationery set', 'Vase filler stones', 'Decorative beads', 'Potpourri', 'Decorative candles', 'Wall sconce', 'Sconce bulbs', 'Picture light', 'Accent lighting strip', 'LED strip lights', 'Smart plug', 'Smart switch', 'Spare keys', 'Keychain', 'Key holder', 'Pet treats', 'Pet feeding mat', 'Pet water bowl', 'Pet food container', 'Lint roller', 'Hand sanitizer', 'Tissues', 'Tissue box cover', 'Coat hanger', 'Hangers', 'Blanket', 'Throw', 'Slipcover', 'Couch cover', 'Chair cover', 'Ottoman cover', 'Seat cushions', 'Back cushions', 'Foam inserts', 'Decorative pillow set', 'Couch pillows', 'Floor rug', 'Area carpet', 'Carpet tape', 'Rug cleaner', 'Fireplace mantel decor', 'Mantel garland', 'Decorative ornaments', 'Home fragrance spray',
            'Essential oil diffuser', 'Essential oils', 'Diffuser pads', 'Room spray', 'Bluetooth remote', 'Smart TV remote', 'TV cleaning kit', 'Screen cleaner', 'Sound system remote', 'Speaker cable', 'Spare HDMI cable', 'Spare batteries', 'Battery organizer', 'Rechargeable batteries', 'Charging station', 'Wireless charger', 'Phone stand', 'Tablet stand', 'Laptop stand', 'Couch tray', 'Snack tray', 'Armchair table', 'Foldable side table', 'Folding table', 'Portable tray table', 'Pet hair remover', 'Lint brush', 'Upholstery cleaner', 'Steam cleaner', 'Fabric freshener', 'Decorative bowls', 'Decorative baskets', 'Storage cube', 'Storage crates', 'Wooden crate', 'Plastic crate', 'Magazine holder', 'Newspapers', 'Subscription magazines', 'Remote battery cover', 'Instruction manuals', 'Warranty documents',
            'Furniture assembly tools', 'Allen wrench set', 'Spare screws and bolts', 'Picture hooks', 'Wall anchors', 'Patch and paint kit', 'Spackle', 'Putty knife', 'Touch-up paint', 'Paint brush', 'Paint roller', 'Drop cloth'],
